            ...
            $.each(nodesGroupArray, function (index, nodes) {
                ...
                $.each(nodes, function (index, node) {
                    ...
                    let circle;
                        ...
                        circle = draw.image('https://cdn.img42.com/4b6f5e63ac50c95fe147052d8a4db676.jpeg').size(settings.circleSize, settings.circleSize).attr({fill: settings.chartColor, class:"circleClass"}).move(text.cx() - settings.circleSize / 2, text.cy() - settings.circleSize / 2 * 3);
